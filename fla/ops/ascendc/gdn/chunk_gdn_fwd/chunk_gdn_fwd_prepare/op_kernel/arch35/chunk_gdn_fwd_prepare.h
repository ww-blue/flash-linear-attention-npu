 ...
 * MMAD each [64,64]@[64,128]. Stage4/5 second MMAD and Stage7 share
 * L0A/L0B even [32,48) odd [48,64), SetSize 16 KiB. L0C even [0,64)
 * odd [64,128). LoadData A 64x64, B 64x128. One
